...
public class Travelsal_Zigzac
{
	...
	{
	    List<List<Integer>> out = getLevelNode(root,allLevelList,0);
    ...
    private static List<List<Integer>> getLevelNode(TreeNode node, List<List<Integer>> allLevelList, int level)
    {
